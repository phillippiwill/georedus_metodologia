# Indicador: Instalações de Atendimento Obstétrico

## Descrição

Presença e quantidade de instalações físicas do tipo "centro obstétrico" na unidade ambulatorial ou de pronto atendimento.
