# Indicador: Instalações de Atendimento Ambulatorial

## Descrição

Presença e quantidade de instalações físicas de atendimento ambulatorial na unidade ambulatorial ou de pronto atendimento.
