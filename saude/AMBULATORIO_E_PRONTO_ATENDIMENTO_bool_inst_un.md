# Indicador: Instalações de Atendimento Neonatal

## Descrição

Presença e quantidade de instalações físicas de atendimento neonatal na unidade ambulatorial ou de pronto atendimento.
